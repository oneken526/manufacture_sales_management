<ul class="sidebar-menu">
    ...
    @role('admin')
        ...
        <li class="sidebar-section">
            <span class="sidebar-section-label">マスタ管理</span>
        </li>
        <li>
        ...
        <li>
            <a href="{{ Route::has('warehouses.index') ? route('warehouses.index') : '#' }}"
               class="sidebar-link {{ request()->routeIs('warehouses.*') ? 'sidebar-link--active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li class="sidebar-section">
            <span class="sidebar-section-label">販売管理</span>
        </li>
        <li>
            <a href="{{ Route::has('quotations.index') ? route('quotations.index') : '#' }}"
               class="sidebar-link {{ request()->routeIs('quotations.*') ? 'sidebar-link--active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li class="sidebar-section">
            <span class="sidebar-section-label">製造</span>
        </li>
        <li>
            <a href="{{ Route::has('manufacture-orders.index') ? route('manufacture-orders.index') : '#' }}"
               class="sidebar-link {{ request()->routeIs('manufacture-orders.*') ? 'sidebar-link--active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li class="sidebar-section">
            <span class="sidebar-section-label">倉庫・出荷</span>
        </li>
        <li>
            <a href="{{ Route::has('shipments.index') ? route('shipments.index') : '#' }}"
               class="sidebar-link {{ request()->routeIs('shipments.*') ? 'sidebar-link--active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li>
            <a href="{{ Route::has('stocks.index') ? route('stocks.index') : '#' }}"
               class="sidebar-link {{ request()->routeIs('stocks.*') ? 'sidebar-link--active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li class="sidebar-section">
            <span class="sidebar-section-label">請求・入金</span>
        </li>
        <li>
            <a href="{{ Route::has('invoices.index') ? route('invoices.index') : '#' }}"
               class="sidebar-link {{ request()->routeIs('invoices.*') ? 'sidebar-link--active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li>
            <a href="{{ Route::has('payments.index') ? route('payments.index') : '#' }}"
               class="sidebar-link {{ request()->routeIs('payments.*') ? 'sidebar-link--active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
